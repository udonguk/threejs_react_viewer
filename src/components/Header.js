const Header = () => {
  return <header>
    ...
    <span className="separator layout-md"> | </span>
    <a className="item layout-md" target="_blank"
       href="https://github.com/mrdoob/three.js/blob/r139/examples/js/loaders/GLTFLoader.js">
    ...
    <button id="download-btn" className="item">⬇&nbsp;&nbsp;&nbsp;Download</button>
  </header>;
}
